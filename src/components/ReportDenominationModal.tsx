...
export default function ReportDenominationModal({
  open,
  onClose,
  cashInHand,
  date,
  ...
  const different = denominationTotalCash - cashInHand;
    ...
    <div className="fixed inset-0 z-50 flex flex-col bg-white overflow-hidden w-full h-[100dvh]">
      ...
      <div className="flex items-center justify-between border-b bg-slate-900 px-4 py-2.5 sm:px-6 sm:py-3 text-white shrink-0">
        <div className="flex items-center gap-2">
          ...
          <div>
            <h3 className="font-bold text-base sm:text-lg leading-tight">Denomination</h3>
      ...
      <div className="border-b bg-slate-100 p-2 sm:p-3 shrink-0">
        <div className="grid grid-cols-3 gap-2 max-w-5xl mx-auto">
          <div className="flex flex-col justify-center rounded-xl border border-slate-300 bg-white p-2 sm:p-2.5 shadow-xs">
            <span className="text-[11px] sm:text-xs font-bold text-slate-700 truncate">Cash in Hand</span>
          ...
          <div className="flex flex-col justify-center rounded-xl border border-indigo-300 bg-indigo-50/90 p-2 sm:p-2.5 shadow-xs">
            <span className="text-[11px] sm:text-xs font-bold text-indigo-950 truncate">Total Cash</span>
          ...
          >
            <div className="flex items-center justify-between gap-1">
              <span className="text-[11px] sm:text-xs font-bold text-slate-800 truncate">Different</span>
            </div>
            <div
      ...
      {showKeypad ? (
        ...
        <div className="flex items-center justify-between border-t bg-slate-50 px-4 py-2.5 sm:px-6 shrink-0">
          <button
            type="button"
            onClick={handleReset}
            className="rounded-lg bg-slate-500 px-5 py-2 text-xs sm:text-sm font-semibold text-white hover:bg-slate-600 transition"
          >
            Reset
          </button>
          <button
